 ...
 */
public class NewYearTrasnportSystem {
    ...
    private static boolean dfs(Vector<Integer> [] edges, int t, boolean[] visited, int vertex) {
        visited[vertex] = true;
