...
import com.dsa.numbertheory.numbertheory1.ExtendedEclidAlgo;
...
public class SachinAndVarunProblem {
    ...
    public static void main(String[] args) {
        ...
        while (t-->0) {
            ...
            long b = in.nextLong();
            long d = in.nextLong();
            // smallest value of y which is called as y1
            // g = gcd of a and b
            Tripplet tripplet = extendedEclid(a,b);
            long g = tripplet.gcd;
            if(d%g!=0){
            ...
            b/=g;
            d/=g;
            long y1 = ((d%a)*multiplicateInverse(b,a))%a;
            long firstValue = d/b;
            if(d<y1*b) {
                System.out.println(0);
                continue;
